...
<style>
  ...
  .home-body > .wrap > p{ font-size:1.05rem; line-height:1.75; color:var(--slate); margin:0 0 28px; max-width:1100px; }
  ...
  .home-body .research-block img{ width:100%; max-width:1100px; border-radius:10px; border:1px solid var(--line); margin:18px 0; }
  .home-body .research-block p{ font-size:1.02rem; line-height:1.8; color:var(--slate); max-width:1100px; }
  ...
  .home-body .research-block .fig-title{ font-family:'IBM Plex Mono',monospace; font-weight:700; font-size:1rem; letter-spacing:.03em; text-transform:uppercase; color:var(--teal-deep); max-width:1100px; margin:18px 0 -6px; }
